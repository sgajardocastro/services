package cl.gesvita.ws.obtenerressolicitudcapaxmes;
 ...
 */
@WebServlet("/WSObtenerResSolicitudCapaxMes/ObtenerResSolicitudCapaxMes")
public class ObtenerResSolicitudCapaxMes extends HttpServlet {

    private static final long serialVersionUID = 1L;
    static Logger logger = Logger.getLogger(ObtenerResSolicitudCapaxMes.class);

    /**
     * @see HttpServlet#HttpServlet()
     */
    public ObtenerResSolicitudCapaxMes() {
        super();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String[] camposytipos = {"ID_EMPRESA","I","FECH_INGRESO_MES","D","CANTIDAD_DISPONIBLE","I","CANTIDAD_UTILIZADO","I"};
 
 
            // Construir el SQL
            StringSql.append("SELECT * FROM VW_RES_SOLICITUDCAPAXMES  avtar ");
            String sqlAnd = " WHERE ";
