package cl.gesvita.ws.instanciarproyectodesdetemplate;
...
/**
 * Servlet implementation class InstanciarProyectoDesdeTemplate
 */
@WebServlet("/WSInstanciarProyectoDesdeTemplate/InstanciarProyectoDesdeTemplate")
public class InstanciarProyectoDesdeTemplate extends HttpServlet {
    private static final long serialVersionUID = 1L;
    static Logger logger = Logger.getLogger(InstanciarProyectoDesdeTemplate.class);

    /**
     * @see HttpServlet#HttpServlet()
     */
    public InstanciarProyectoDesdeTemplate() {
        super();
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            stmt = conn.prepareCall("{call PKG_PROYECTO_INSTANCIAR.CLONAPROYECTO(?,?,to_date(?, \'DD/MM/YYYY\'),?,?,?,?)}");
