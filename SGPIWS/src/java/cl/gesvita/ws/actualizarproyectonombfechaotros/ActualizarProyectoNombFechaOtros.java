package cl.gesvita.ws.actualizarproyectonombfechaotros;
...
/**
 * Servlet implementation class ActualizarProyectoNombFechaOtros
 */
@WebServlet("/WSActualizarProyectoNombFechaOtros/ActualizarProyectoNombFechaOtros")
public class ActualizarProyectoNombFechaOtros extends HttpServlet {
    private static final long serialVersionUID = 1L;
    static Logger logger = Logger.getLogger(ActualizarProyectoNombFechaOtros.class);

    /**
     * @see HttpServlet#HttpServlet()
     */
    public ActualizarProyectoNombFechaOtros() {
        super();
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            stmt = conn.prepareCall("{call PKG_MONITOR_UPDATE.PROYECTO_SETUP_NOMBFECHOTH_UP(?,?,to_date(?, \'DD/MM/YYYY\'),to_date(?, \'DD/MM/YYYY\'),?,?,?,?)}");
                        clob = conn.createClob();
                        stmt.setFloat(1, Float.parseFloat(readFieldString(jsonObj,"in_id_proyecto")));
                        stmt.setString(2, readFieldString(jsonObj,"in_nombre_proyecto"));
                        stmt.setString(3, readFieldString(jsonObj,"in_fecha_plan_ini"));
                        stmt.setString(4, readFieldString(jsonObj,"in_fecha_plan_fin"));
                        stmt.setFloat(5, Float.parseFloat(readFieldString(jsonObj,"in_id_estado")));
                        stmt.setFloat(6, Float.parseFloat(readFieldString(jsonObj,"in_id_usuario_modificacion")));
