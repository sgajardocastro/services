package cl.gesvita.ws.eliminarproyectoall;
...
/**
 * Servlet implementation class EliminarProyectoAll
 */
@WebServlet("/WSEliminarProyectoAll/EliminarProyectoAll")
public class EliminarProyectoAll extends HttpServlet {
    private static final long serialVersionUID = 1L;
    static Logger logger = Logger.getLogger(EliminarProyectoAll.class);

    /**
     * @see HttpServlet#HttpServlet()
     */
    public EliminarProyectoAll() {
        super();
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            stmt = conn.prepareCall("{call PKG_MONITOR_DELETE.PROYECTO_ELIMINAR_PROYECTOALL(?,?,?)}");
