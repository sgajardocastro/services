...
/**
 * Servlet implementation class ObtenerInformacionRecurso
 */
@WebServlet("/WSObtenerInformacionRecurso/ObtenerInformacionRecurso")
public class ObtenerInformacionRecurso extends HttpServlet {
    private static final long serialVersionUID = 1L;
    static Logger logger = Logger.getLogger(ObtenerInformacionRecurso.class);

    /**
     * @see HttpServlet#HttpServlet()
     */
    public ObtenerInformacionRecurso() {
        super();
    }
