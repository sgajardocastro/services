package cl.gesvita.ws.quitarunusuariodegrupo;
...
/**
 * Servlet implementation class QuitarUnUsuarioDeGrupo
 */
@WebServlet("/WSQuitarUnUsuarioDeGrupo/QuitarUnUsuarioDeGrupo")
public class QuitarUnUsuarioDeGrupo extends HttpServlet {

    private static final long serialVersionUID = 1L;
    static Logger logger = Logger.getLogger(QuitarUnUsuarioDeGrupo.class);

    /**
     * @see HttpServlet#HttpServlet()
     */
    public QuitarUnUsuarioDeGrupo() {
        super();
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            stmt = conn.prepareCall("{call PKG_MONITOR_DELETE.GRUPO_USUARIO_DELUNITARIO(?,?,?,?,?)}");
            clob = conn.createClob();
            stmt.setFloat(1, Float.parseFloat(readFieldString(jsonObj, "in_id_empresa")));
            stmt.setString(2, readFieldString(jsonObj, "in_codi_grupo"));
