package cl.gesvita.ws.actualizarnotificacionlectura;
...
/**
 * Servlet implementation class ActualizarNotificacionLectura
 */
@WebServlet("/WSActualizarNotificacionLectura/ActualizarNotificacionLectura")
public class ActualizarNotificacionLectura extends HttpServlet {

    private static final long serialVersionUID = 1L;
    static Logger logger = Logger.getLogger(ActualizarNotificacionLectura.class);

    /**
     * @see HttpServlet#HttpServlet()
     */
    public ActualizarNotificacionLectura() {
        super();
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            stmt = conn.prepareCall("{call PKG_ALERTA_NOTIFICACIONES.ALERTA_ENVIO_UP(?,?,?,?)}");
            clob = conn.createClob();
            stmt.setFloat(1, Float.parseFloat(readFieldString(jsonObj, "in_id_alerta_envio")));
            stmt.setString(2, readFieldString(jsonObj, "in_id_usuario_quelee"));
