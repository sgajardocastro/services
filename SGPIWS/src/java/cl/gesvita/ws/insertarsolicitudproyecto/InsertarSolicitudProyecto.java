 ...
 */
@WebServlet("/WSInsertarSolicitudProyecto/InsertarSolicitudProyecto")
public class InsertarSolicitudProyecto extends HttpServlet {

    private static final long serialVersionUID = 1L;
    static Logger logger = Logger.getLogger(InsertarSolicitudProyecto.class);

    /**
     * @see HttpServlet#HttpServlet()
     */
    public InsertarSolicitudProyecto() {
        super();
    }
