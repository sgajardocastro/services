package cl.gesvita.ws.obtenerformularioencuesta;
...
/**
 * Servlet implementation class ObtenerFormularioEncuesta
 */
@WebServlet("/WSObtenerFormularioEncuesta/ObtenerFormularioEncuesta")
public class ObtenerFormularioEncuesta extends HttpServlet {

    private static final long serialVersionUID = 1L;
    static Logger logger = Logger.getLogger(ObtenerFormularioEncuesta.class);

    /**
     * @see HttpServlet#HttpServlet()
     */
    public ObtenerFormularioEncuesta() {
        super();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      String salida = "{\"resultadoEjecucion\":\"OK\",\"items\":{" +
                    "\"item\":[{" +
                    "\"id\":\"1000\"," +
                    "\"descripcion\":\"EVALUACIÓN DE RIESGOS Y PLANIFICACIÓN DE MEDIDAS PREVENTIVAS\"," +
                    "\"valores\":\"NA=0, C=0, I=0, RI=0, L=0, G=0, MG=0\"" +
                    "}," +
                    "{" +
                    "\"id\": \"1001\"," +
                    "\"descripcion\": \"PLAN DE SEGURIDAD Y SALUD (obras de construcción)\"," +
                    "\"valores\": \"NA=0, C=0, I=0, RI=0, L=0, G=0, MG=0\"" +
                    "}" +
                    "]" +
                    "}}";
