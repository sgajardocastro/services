package cl.gesvita.ws.actualizarproyectoestadoall;
...
/**
 * Servlet implementation class ActualizarProyectoEstadoAll
 */
@WebServlet("/WSActualizarProyectoEstadoAll/ActualizarProyectoEstadoAll")
public class ActualizarProyectoEstadoAll extends HttpServlet {
    private static final long serialVersionUID = 1L;
    static Logger logger = Logger.getLogger(ActualizarProyectoEstadoAll.class);

    /**
     * @see HttpServlet#HttpServlet()
     */
    public ActualizarProyectoEstadoAll() {
        super();
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            stmt = conn.prepareCall("{call PKG_MONITOR_UPDATE.PROYECTO_SETUP_ESTADO_UP(?,?,?,?,?)}");
