package cl.gesvita.ws.validaseguridadusuario;
...
/**
 * Servlet implementation class ValidaSeguridadUsuario
 */
@WebServlet("/WSValidaSeguridadUsuario/ValidaSeguridadUsuario")
public class ValidaSeguridadUsuario extends HttpServlet {
    private static final long serialVersionUID = 1L;
    static Logger logger = Logger.getLogger(ValidaSeguridadUsuario.class);


    /**
     * @see HttpServlet#HttpServlet()
     */
    public ValidaSeguridadUsuario() {
        super();
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (jsonout.has("1") && (jsonout.get("1") instanceof JsonObject)) {
                JsonObject jsonout2 = (JsonObject) jsonout.get("1");
