package cl.gesvita.ws.editarproyectodataext;
...
/**
 * Servlet implementation class EditarProyectoDataExt
 */
@WebServlet("/WSEditarProyectoDataExt/EditarProyectoDataExt")
public class EditarProyectoDataExt extends HttpServlet {
    private static final long serialVersionUID = 1L;
    static Logger logger = Logger.getLogger(EditarProyectoDataExt.class);

    /**
     * @see HttpServlet#HttpServlet()
     */
    public EditarProyectoDataExt() {
        super();
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            dataRetornar.put("out_mensaje", "Error en conexiÃ³n a BD");
        ...
        try {
            ...
            stmt = conn.prepareCall("{call PKG_MONITOR_UPDATE.PROYECTO_SETUP_DATAEXT(?,?,?,?,?)}");
            ...
            logger.error(ex.fillInStackTrace());
            dataRetornar.put("out_codigo", 9999);
            dataRetornar.put("out_mensaje", "ParÃ¡metro JSON no esperado");
            sendData(response, out, dataRetornar);
