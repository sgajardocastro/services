 ...
 */
@WebServlet("/WSObtenerResSolicitudCapaxMesV2/ObtenerResSolicitudCapaxMesV2old")
public class ObtenerResSolicitudCapaxMesV2old extends HttpServlet {

    private static final long serialVersionUID = 1L;
    static Logger logger = Logger.getLogger(ObtenerResSolicitudCapaxMesV2old.class);

    /**
     * @see HttpServlet#HttpServlet()
     */
    public ObtenerResSolicitudCapaxMesV2old() {
        super();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String[] camposytipos = {"ID_EMPRESA","I","ID_PROYECTO_TEMPLATE","/I","ID_SUCURSAL","/I","TIPO_RUBRO","/S","TIPO_ESPACIO","/S","FECH_INGRESO_MES","D","CANTIDAD_DISPONIBLE","+I","CANTIDAD_UTILIZADO","+I"};
            // Construir el SQL
            StringSql.append("SELECT id_empresa , fech_ingreso_mes ");
            StringSql.append(",sum(cantidad_disponible) cantidad_disponible");
            StringSql.append(",sum(cantidad_utilizado) cantidad_utilizado ");
            StringSql.append(" FROM VW_RES_SOLICITUDCAPAXMES  avtar ");
            ...
            if (m.containsKey("fech_ingreso_mes-min")) {
                StringSql.append(sqlWhereAnd + " ");
                StringSql.append("avtar.FECH_INGRESO_MES >= TO_date(?,'dd/mm/yyyy') ");
                sqlWhereAnd = " AND ";
            }
            if (m.containsKey("fech_ingreso_mes-max")) {
                StringSql.append(sqlWhereAnd + " ");
                StringSql.append("avtar.FECH_INGRESO_MES < TO_DATE(?,'dd/mm/yyyy') + 1 ");
            }
            
            StringSql.append(" group by id_empresa , fech_ingreso_mes");
            StringSql.append(" order by fech_ingreso_mes");
