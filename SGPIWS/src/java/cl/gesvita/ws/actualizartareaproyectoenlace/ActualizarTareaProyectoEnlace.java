package cl.gesvita.ws.actualizartareaproyectoenlace;
...
/**
 * Servlet implementation class ActualizarTareaProyectoEnlace
 */
@WebServlet("/WSActualizarTareaProyectoEnlace/ActualizarTareaProyectoEnlace")
public class ActualizarTareaProyectoEnlace extends HttpServlet {
    private static final long serialVersionUID = 1L;
    static Logger logger = Logger.getLogger(ActualizarTareaProyectoEnlace.class);

    /**
     * @see HttpServlet#HttpServlet()
     */
    public ActualizarTareaProyectoEnlace() {
        super();
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            stmt = conn.prepareCall("{call PKG_MONITOR_UPDATE.PROYECTO_TAREA_PROYECTOENLACE_UP(?,?,?,?,?)}");
                        ...
                        stmt.setFloat(3, Float.parseFloat(readFieldString(jsonObj,"in_id_proyecto_enlace")));
