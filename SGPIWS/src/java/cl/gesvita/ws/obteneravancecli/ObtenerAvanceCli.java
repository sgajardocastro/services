package cl.gesvita.ws.obteneravancecli;
...
/**
 * Servlet implementation class ObtenerAvanceCli
 */
@WebServlet("/WSObtenerAvanceCli/ObtenerAvanceCli")
public class ObtenerAvanceCli extends HttpServlet {

    private static final long serialVersionUID = 1L;
    static Logger logger = Logger.getLogger(ObtenerAvanceCli.class);

    /**
     * @see HttpServlet#HttpServlet()
     */
    public ObtenerAvanceCli() {
        super();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            // Construir el SQL
            StringSql.append("SELECT * FROM VW_PROYECTO_SOLICCLI WHERE ");
            String sqlAnd = "";
