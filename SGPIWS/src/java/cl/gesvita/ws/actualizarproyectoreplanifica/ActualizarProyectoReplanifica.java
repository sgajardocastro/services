 ...
 */
@WebServlet("/WSActualizarProyectoReplanifica/ActualizarProyectoReplanifica")
public class ActualizarProyectoReplanifica extends HttpServlet {
    private static final long serialVersionUID = 1L;
    static Logger logger = Logger.getLogger(ActualizarProyectoReplanifica.class);

    /**
     * @see HttpServlet#HttpServlet()
     */
    public ActualizarProyectoReplanifica() {
        super();
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            stmt = conn.prepareCall("{call PKG_MONITOR_UPDATE.PROYECTO_REPLANIFICA(?,to_date(?, \'DD/MM/YYYY\'),?,?,?,?,?)}");
                        ...
                        stmt.setString(2, readFieldString(jsonObj,"in_fecha_plan_ini_replan"));
                        stmt.setFloat(3, Float.parseFloat(readFieldString(jsonObj,"in_id_usuario_quemodifica")));
                        stmt.setString(4, readFieldString(jsonObj,"in_flag_replan_detenido"));
                        stmt.setString(5, readFieldString(jsonObj,"in_flag_replan_ejecucion"));
