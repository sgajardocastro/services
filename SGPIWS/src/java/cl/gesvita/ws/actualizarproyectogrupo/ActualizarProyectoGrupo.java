package cl.gesvita.ws.actualizarproyectogrupo;
...
/**
 * Servlet implementation class ActualizarProyectoGrupo
 */
@WebServlet("/WSActualizarProyectoGrupo/ActualizarProyectoGrupo")
public class ActualizarProyectoGrupo extends HttpServlet {
    private static final long serialVersionUID = 1L;
    static Logger logger = Logger.getLogger(ActualizarProyectoGrupo.class);

    /**
     * @see HttpServlet#HttpServlet()
     */
    public ActualizarProyectoGrupo() {
        super();
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            stmt = conn.prepareCall("{call PKG_MONITOR_UPDATE.PROYECTO_ACTUALIZAGRUPO_UP(?,?,?,?)}");
