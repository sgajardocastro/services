package cl.gesvita.ws.obtenergruposresopexareatipov2;
...
/**
 * Servlet implementation class ObtenerGruposResOpexAreaTipoV2
 */
@WebServlet("/WSObtenerGruposResOpexAreaTipoV2/ObtenerGruposResOpexAreaTipoV2")
public class ObtenerGruposResOpexAreaTipoV2 extends HttpServlet {

    private static final long serialVersionUID = 1L;
    static Logger logger = Logger.getLogger(ObtenerGruposResOpexAreaTipoV2.class);

    /**
     * @see HttpServlet#HttpServlet()
     */
    public ObtenerGruposResOpexAreaTipoV2() {
        super();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            // Construir el SQL
            StringSql.append("SELECT * FROM VW_GRUPOS_RESOPEXAREATIPO avtar");
...
// 1.-- Check de Usuario participante en Mesa
            ...
            StringSql.append(" and avtar.id_tipo_grupo = grupo.id_tipo_grupo ");
