package cl.gesvita.ws.actualizarproyectoestado;
...
/**
 * Servlet implementation class ActualizarProyectoEstado
 */
@WebServlet("/WSActualizarProyectoEstado/ActualizarProyectoEstado")
public class ActualizarProyectoEstado extends HttpServlet {
    private static final long serialVersionUID = 1L;
    static Logger logger = Logger.getLogger(ActualizarProyectoEstado.class);

    /**
     * @see HttpServlet#HttpServlet()
     */
    public ActualizarProyectoEstado() {
        super();
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            stmt = conn.prepareCall("{call PKG_MONITOR_UPDATE.PROYECTO_SETUP_ESTADO(?,?,?,?)}");
