package cl.gesvita.ws.actualizarusuariopassword;
...
/**
 * Servlet implementation class ActualizarUsuarioPassword
 */
@WebServlet("/WSActualizarUsuarioPassword/ActualizarUsuarioPassword")
public class ActualizarUsuarioPassword extends HttpServlet {
    private static final long serialVersionUID = 1L;
    static Logger logger = Logger.getLogger(ActualizarUsuarioPassword.class);

    /**
     * @see HttpServlet#HttpServlet()
     */
    public ActualizarUsuarioPassword() {
        super();
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            stmt = conn.prepareCall("{call PKG_MONITOR_UPDATE.USUARIO_PASSWORD(?,?,?,?,?)}");
                        clob = conn.createClob();
                        stmt.setFloat(1, Float.parseFloat(readFieldString(jsonObj,"in_id_usuario")));
                        stmt.setString(2, readFieldString(jsonObj,"in_new_pass"));
                        stmt.setString(3, readFieldString(jsonObj,"in_old_pass"));
