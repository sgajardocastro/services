package cl.gesvita.ws.obtenerformulariolocalidades;
 ...
 */
@WebServlet("/WSObtenerFormularioLocalidades/ObtenerFormularioLocalidades")
public class ObtenerFormularioLocalidades extends HttpServlet {

    private static final long serialVersionUID = 1L;
    static Logger logger = Logger.getLogger(ObtenerFormularioLocalidades.class);

    /**
     * @see HttpServlet#HttpServlet()
     */
    public ObtenerFormularioLocalidades() {
        super();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String fieldName = "id_usuario";
            String id_usuario = leerCampo(jsonObj,fieldName);
            
            // ,\"id\":\""+ id_usuario + "\"
            salida[0] = "{\"resultadoEjecucion\":\"OK\",\"localidades\":{\"1\":{\"id\":\"001001\",\"name\":\"Arica\"},\"2\":{\"id\":\"002002\",\"name\":\"Iquique\"}}}";
            salida[1] = "{\"resultadoEjecucion\":\"OK\",\"localidades\":{\"1\":{\"id\":\"005005\",\"name\":\"Valparaiso\"},\"2\":{\"id\":\"013001\",\"name\":\"Santiago\"},\"3\":{\"id\":\"013002\",\"name\":\"Melipilla\"},\"4\":{\"id\":\"013003\",\"name\":\"Oriente Metropolitano\"}}}";
            salida[2] = "{\"resultadoEjecucion\":\"OK\",\"localidades\":{\"1\":{\"id\":\"008008\",\"name\":\"Temuco\"},\"2\":{\"id\":\"009009\",\"name\":\"Parral\"}}}";
