package cl.gesvita.ws.agregarusuariosdesdegrupo;
...
/**
 * Servlet implementation class AgregarUsuariosDesdeGrupo
 */
@WebServlet("/WSAgregarUsuariosDesdeGrupo/AgregarUsuariosDesdeGrupo")
public class AgregarUsuariosDesdeGrupo extends HttpServlet {
    private static final long serialVersionUID = 1L;
    static Logger logger = Logger.getLogger(AgregarUsuariosDesdeGrupo.class);

    /**
     * @see HttpServlet#HttpServlet()
     */
    public AgregarUsuariosDesdeGrupo() {
        super();
    }
	...
	Clob clob;
        ...
        try {
            ...
            stmt = conn.prepareCall("{call PKG_MONITOR_INSERT.CLONAGRUPO(?,?,?,?)}");
            clob = conn.createClob();
            stmt.setString(1, readFieldString(jsonObj,"in_codi_grupo_origen"));
            stmt.setString(2, readFieldString(jsonObj,"in_codi_grupo_destino"));
