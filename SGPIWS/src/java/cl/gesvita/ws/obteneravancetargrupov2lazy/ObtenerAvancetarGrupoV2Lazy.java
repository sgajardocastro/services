package cl.gesvita.ws.obteneravancetargrupov2lazy;
 ...
 */
@WebServlet("/WSObtenerAvancetarGrupoV2L/ObtenerAvancetarGrupoV2L")
public class ObtenerAvancetarGrupoV2Lazy extends HttpServlet {
    private static final long serialVersionUID = 1L;
    static Logger logger = Logger.getLogger(ObtenerAvancetarGrupoV2Lazy.class);

    /**
     * @see HttpServlet#HttpServlet()
     */
    public ObtenerAvancetarGrupoV2Lazy() {
        super();
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            // Inicializar Log4J
            ObtenerLib.setLogParam(ObtenerAvancetarGrupoV2Lazy.class);
            // Obtener Data Source
        ...
        try {
            ...
            String campos = "/* +RULES */ ID_PROYECTO,FECHA_CREACION,NOMBRE"
                    + ",ID_ESTADO_PROYECTO,NOMBRE_ESTADO_PROYECTO"
                    + ",ID_USUARIO_CREACION,ID_PROYECTO_TEMPLATE"
                    + ",NOMBRE_REQUERIMIENTO"
                    + ",NOMBRE_JEFEPROYECTO,FECHA_REAL_INIPROY,NOMBRE_USUARIO_CREACION, FECHA_REAL_INIPROY_DATE";
            String extratabla = "";
            String continuacion;
            ...
            boolean hay_id_area = (jsonObj.has("ID_AREA_USUARIO_REQUEST".toLowerCase()));
            if (hay_id_area) {
                continuacion =   continuacion 
                             + " or exists (select 1 from dual check"
                             + " where avtar.id_requerimiento = 2029 and {{ID_AREA_USUARIO_REQUEST}} = 3"
                             + " )";
            }
                             // Sub select 5
            continuacion =   continuacion + " or exists (select 1 from vw_seguridad_usuario usuario,"
...
//            ObtenerLib.addToken(mapa, 'I', jsonObj ,"ID_AREA_USUARIO_REQUEST");
            ...
            String[] camposytipos = {
                    "ID_EMPRESA","/I","ID_PROYECTO","I","NOMBRE","S","FECHA_CREACION","S","ID_TIPO","/I","OBSERVACION_ACTUAL","/S","ID_PROYECTO_PADRE","/I"
                    ...
                    ,"FECHA_PLAN_FINPROY","/S","FECHA_REAL_INIPROY_DATE","D","ID_TAREA_PADRE","/I","NOMBRE_TAREA_PADRE","/S","ID_TIPO_TAREA_PADRE","/I","NOMBRE_TIPO_PADRE","/S"
            ...
            String json = ObtenerLib.getDefaultObtenerResoultSetExt(logger, connection,
                    camposytipos, "VW_PROYECTO_AVANCETARGRUPO2" , jsonObj,extratabla,campos,continuacion, mapa);
            // Imprimir la salida
            out.print(json);
