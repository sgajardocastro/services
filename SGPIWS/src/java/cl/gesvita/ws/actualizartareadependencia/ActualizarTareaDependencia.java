package cl.gesvita.ws.actualizartareadependencia;
...
/**
 * Servlet implementation class ActualizarTareaDependencia
 */
@WebServlet("/WSActualizarTareaDependencia/ActualizarTareaDependencia")
public class ActualizarTareaDependencia extends HttpServlet {
    private static final long serialVersionUID = 1L;
    static Logger logger = Logger.getLogger(ActualizarTareaDependencia.class);

    /**
     * @see HttpServlet#HttpServlet()
     */
    public ActualizarTareaDependencia() {
        super();
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            stmt = conn.prepareCall("{call PKG_MONITOR_UPDATE.PROYECTO_TAREA_DEPENDENCIA_UP(?,?,?,?,?)}");
                        ...
                        stmt.setString(3, readFieldString(jsonObj,"in_id_tarea_dependencia"));
