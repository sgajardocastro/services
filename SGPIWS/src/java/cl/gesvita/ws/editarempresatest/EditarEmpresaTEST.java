package cl.gesvita.ws.editarempresatest;
...
/**
 * Servlet implementation class EditarEmpresaTEST
 */
@WebServlet("/WSEditarEmpresaTEST/EditarEmpresaTEST")
public class EditarEmpresaTEST extends HttpServlet {
    private static final long serialVersionUID = 1L;
    static Logger logger = Logger.getLogger(EditarEmpresaTEST.class);

    /**
     * @see HttpServlet#HttpServlet()
     */
    public EditarEmpresaTEST() {
        super();
    }
