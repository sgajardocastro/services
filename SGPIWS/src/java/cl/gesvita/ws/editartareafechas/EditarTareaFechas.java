package cl.gesvita.ws.editartareafechas;
...
/**
 * Servlet implementation class EditarTareaFechas
 */
@WebServlet("/WSEditarTareaFechas/EditarTareaFechas")
public class EditarTareaFechas extends HttpServlet {
    private static final long serialVersionUID = 1L;
    static Logger logger = Logger.getLogger(EditarTareaFechas.class);

    /**
     * @see HttpServlet#HttpServlet()
     */
    public EditarTareaFechas() {
        super();
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            stmt = conn.prepareCall("{call PKG_MONITOR_UPDATE.PROYECTO_TAREA_FECHAS_UP(?,?,to_date(?, \'DD/MM/YYYY\'),to_date(?, \'DD/MM/YYYY\'),to_date(?, \'DD/MM/YYYY\'),to_date(?, \'DD/MM/YYYY\'),?,?)}");
            clob = conn.createClob();
            stmt.setFloat(1, Float.parseFloat(readFieldString(jsonObj,"in_id_tarea")));
            stmt.setFloat(2, Float.parseFloat(readFieldString(jsonObj,"in_id_usuario_modificacion")));
            stmt.setString(3, readFieldString(jsonObj,"in_fecha_plan_ini"));
            stmt.setString(4, readFieldString(jsonObj,"in_fecha_plan_fin"));
            stmt.setString(5, readFieldString(jsonObj,"in_fecha_real_ini"));
            stmt.setString(6, readFieldString(jsonObj,"in_fecha_real_fin"));
