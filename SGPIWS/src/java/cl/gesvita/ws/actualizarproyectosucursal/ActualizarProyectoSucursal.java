package cl.gesvita.ws.actualizarproyectosucursal;
...
/**
 * Servlet implementation class ActualizarProyectoSucursal
 */
@WebServlet("/WSActualizarProyectoSucursal/ActualizarProyectoSucursal")
public class ActualizarProyectoSucursal extends HttpServlet {
    private static final long serialVersionUID = 1L;
    static Logger logger = Logger.getLogger(ActualizarProyectoSucursal.class);

    /**
     * @see HttpServlet#HttpServlet()
     */
    public ActualizarProyectoSucursal() {
        super();
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            stmt = conn.prepareCall("{call PKG_MONITOR_UPDATE.PROYECTO_SETUP_SUCURSAL_UP(?,?,?,?,?,?)}");
                        clob = conn.createClob();
                        stmt.setFloat(1, Float.parseFloat(readFieldString(jsonObj,"in_id_proyecto")));
                        stmt.setFloat(2, Float.parseFloat(readFieldString(jsonObj,"in_id_sucursal")));
                        stmt.setFloat(3, Float.parseFloat(readFieldString(jsonObj,"in_id_empresa_cliente")));
                        stmt.setFloat(4, Float.parseFloat(readFieldString(jsonObj,"in_id_usuario_quemodifica")));
